...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    productTempNeutrons = temperature * neutrons_emitted
    return temperature < 800 and neutrons_emitted > 500 and productTempNeutrons < 500000 
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    productTempNeutrons = temperature * neutrons_produced_per_second
    lowPercentThreshold = 90*threshold/100
    normalPercentThreshold = 10*threshold/100
    topNormalPercentThreshold = threshold + normalPercentThreshold
    lowNormalPercentThreshold = threshold - normalPercentThreshold

    if productTempNeutrons < lowPercentThreshold :
        return "LOW"
    elif productTempNeutrons <= topNormalPercentThreshold and productTempNeutrons >= lowNormalPercentThreshold :
        return "NORMAL"
    else:
        return "DANGER"
